...
#define BLE6A20_TX_PIN       (UART8_RX_D17)                          // 蓝牙串口对应模块的 TX 要接到单片机的 RX
#define BLE6A20_RX_PIN       (UART8_TX_D16)                          // 蓝牙串口对应模块的 RX 要接到单片机的 TX
#define BLE6A20_RTS_PIN      (D26)                                   // 蓝牙串口对应模块的 RTS 引脚
